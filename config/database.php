...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'oracle_uat' => [
            'driver'         => 'oracle',
            'service_name'   => env('UAT_SERVICE_NAME', ''),
            'host'           => env('UAT_HOST', ''),
            'port'           => env('UAT_PORT', ''),
            'database'       => env('UAT_DATABASE', ''),
            'username'       => env('UAT_USERNAME', ''),
            'password'       => env('UAT_PASSWORD', ''),
            'charset'        => env('UAT_CHARSET', 'AL32UTF8'),
            'prefix'         => env('UAT_PREFIX', ''),
            'prefix_schema'  => env('UAT_SCHEMA_PREFIX', ''),
            'edition'        => env('UAT_EDITION', 'ora$base'),
            'server_version' => env('UAT_SERVER_VERSION', '11g'),
        ],
